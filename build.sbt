...
lazy val commonSettings = commonSmlBuildSettings ++ Seq(
  organization := "io.github.sonac.triplan",
  scalaVersion := "2.13.1",
...
lazy val buildInfoSettings = Seq(
  ...
  buildInfoPackage := "io.github.sonac.triplan.version",
  buildInfoObject := "BuildInfo"
)

lazy val fatJarSettings = Seq(
  assemblyJarName in assembly := "triplan.jar",
...
lazy val backend: Project = (project in file("backend"))
  .settings(
    ...
    mainClass in Compile := Some("io.github.sonac.triplan.Main")
  )
